...
- **Map to the matrix:** translate X and Z to two of the 39 standard parameters
  ...
  `python .agents/skills/triz-innovation/scripts/triz_matrix.py <improving_id> <worsening_id>`.
...
> Tip: `python .agents/skills/triz-innovation/scripts/triz_router.py "problem text"`
...
`python .agents/skills/triz-innovation/scripts/triz_evaluator.py solutions.csv`.
...
- **Su-Field + 76 Standard Solutions** → `references/substance-field-analysis.md`.
  ...
  `python .agents/skills/triz-innovation/scripts/triz_standard_solutions.py --state <incomplete|insufficient|harmful|measurement|excessive>`.
...
- **Evolution Trends + S-curve** → `references/evolution-trends.md`. Use for "where
  ...
  and walk the 8 trends: `python .agents/skills/triz-innovation/scripts/triz_evolution.py --signals "..."`.
...
`python .agents/skills/triz-innovation/scripts/triz_case_template.py "Short problem title"`
...
`python .agents/skills/triz-innovation/scripts/triz.py <command> [args]`.
