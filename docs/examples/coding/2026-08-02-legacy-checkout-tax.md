...
- **Criterio di successo/fallimento:** characterization test invariato e
  `lastAmount` del fake uguale al totale con tassa; nessuna chiamata di rete.
...
Caso illustrativo senza repository legacy allegato: seam, baseline e importo
addebitato non sono stati eseguiti e non vengono presentati come risultati.

## Follow-up

Acquisire il comportamento corrente con un fake del gateway, poi introdurre la
funzione pura e registrare il diff/test reali.
