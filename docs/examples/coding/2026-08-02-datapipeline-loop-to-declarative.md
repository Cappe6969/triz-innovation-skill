...
- **Criterio di successo/fallimento:** output identico al baseline sulle fixture
  scelte e nessun peggioramento misurabile sul carico rappresentativo.
...
Esempio progettuale: non contiene il worker originale né una patch, quindi non
attribuisce riduzioni di righe o prestazioni non misurate.

## Follow-up

Congelare l'output del loop corrente come oracolo, applicare una trasformazione
alla volta e misurare soltanto sul dataset reale.
