...
- **Test/esperimento:** 12 test sull'interfaccia pubblica (validi, invalidi,
  duplicati, scan-positivo); mock del servizio S3.
- **Criterio di successo/fallimento:** 12/12 verdi; il chiamante di esempio usa
  1 sola chiamata; 0 riferimenti a classi interne nel codice consumer.
